...
mod test {
  ...
  use crate::{
    provider::{
      ipa_pc, Bn256EngineIPA, GrumpkinEngine, PallasEngine, Secp256k1Engine, Secq256k1Engine, VestaEngine
    },
  ...
  fn test_compression_with_circuit_size_difference() {
    ...
    test_compression_with_circuit_size_difference_with::<Bn256EngineIPA, GrumpkinEngine, S1PP<_>, S2<_>>(
    );
    ...
    test_compression_with_circuit_size_difference_with::<Bn256EngineIPA, GrumpkinEngine, S1<_>, S2<_>>(
    );
    test_compression_with_circuit_size_difference_with::<
      Secp256k1Engine,
      Secq256k1Engine,
