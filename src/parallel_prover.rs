  ...
  C2: StepCircuit<G2::Scalar>,
{
  ...
  pub fn merge(
    ...
    let inputs_secondary: NovaAugmentedParallelCircuitInputs<G1> = NovaAugmentedParallelCircuitInputs::<G1>::new(
      pp.r1cs_shape_primary.get_digest(),
    ...
    let u_secondary = RelaxedR1CSInstance::from_r1cs_instance(&pp.ck_secondary, &pp.r1cs_shape_secondary, &u_secondary);
