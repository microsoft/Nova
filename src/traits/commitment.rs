...
use crate::{provider::ptau::PtauFileError, traits::{AbsorbInROTrait, Engine, TranscriptReprTrait}};
use core::{
  fmt::Debug,
...
pub trait CommitmentEngineTrait<E: Engine>: Clone + Send + Sync {
  ...
  fn load_setup(reader: &mut impl std::io::Read, n: usize) -> Result<Self::CommitmentKey, PtauFileError>;
