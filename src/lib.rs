  ...
  C2: StepCircuit<E2::Scalar>,
{
  z0_primary: Vec<E1::Scalar>,
  z0_secondary: Vec<E2::Scalar>,
  r_Ui_primary: RelaxedR1CSInstance<E1>,
  ...
  C2: StepCircuit<E2::Scalar>,
{
  ...
  pub fn prove_step_randomizing(
    ...
    let _zi_primary = circuit_primary.synthesize(&mut cs_primary)?;
    ...
    */
    ...
    // fold the secondary circuit's instance
    let (nifs_Ui_prime_secondary, (_r_Ui_prime_secondary, r_Wi_prime_secondary)) =
      NIFS::prove_relaxed(
        &pp.ck_secondary,
        &pp.ro_consts_secondary,
        &scalar_as_base::<E1>(pp.digest()),
    ...
    // fold the primary circuit's instance
    let (nifs_Ui_prime_primary, (_r_Ui_prime_primary, r_Wi_prime_primary)) = NIFS::prove_relaxed(
      &pp.ck_primary,
      &pp.ro_consts_primary,
      &pp.digest(),
      &pp.r1cs_shape_primary,
    ...
    Ok(RandomRecursiveSNARK {
      ...
      r_Ui_primary: self.r_U_primary.clone(),
      r_Ui_secondary: self.r_U_secondary.clone(),
      l_ui_primary,
      l_ui_secondary: self.l_u_secondary.clone(),
      // no r_i ??
      l_Ur_primary,
      l_Ur_secondary,
